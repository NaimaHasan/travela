...
class ItineraryColumn extends StatefulWidget {
  const ItineraryColumn({Key? key, required this.trip, required this.isScrollable}) : super(key: key);
      ...
      children: [
        ...
        Positioned(
          ...
          child: FloatingActionButton(
            onPressed: () async {
              await ItineraryController.newEntry(context, widget.trip.tripID!);
              setState(() {
                _future =
                    ItineraryController.getAllEntries(widget.trip.tripID!);
              });
            },
